...
class Buku extends CI_Controller
{
    ...
    public function ubahKategori()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-message" role="alert">Data Kategori Berhasil diubah</div>');
            redirect('buku/kategori');
        }
    }
    ...
    public function hapusKategori()
    {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">Data Kategori Berhasil dihapus</div>');
        redirect('buku/kategori');
    }
}
