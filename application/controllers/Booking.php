...
class Booking extends CI_Controller
{
    ...
    public function tambahBooking()
    {
        ...
        $d = $this->db->query("Select * from buku where id_buku ='$id_buku'")->row();
    ...
    public function hapusbooking()
    {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-massege alert-danger" role="alert">Buku Berhasil di hapus</div>');
    ...
    public function bookingSelesai($where)
    {
        ...
        $this->db->query("UPDATE buku, temp SET buku.dibooking=buku.dibooking+1, buku.stok=buku.stok-1 WHERE buku.id_buku=temp.id_buku");
